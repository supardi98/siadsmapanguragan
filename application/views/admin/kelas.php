       ...
       <div class="container-fluid" id="container-wrapper">
          ...
          <button type="button"  class="btn btn-success btn-sm col-mb-4" data-toggle="modal" data-target="#exampleModal"
                    id="#myBtn">
                  ...
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                        <button type="button"  class="btn btn-danger col-mb-4" data-toggle="modal" data-target="#exampleModal2"
                            id="#myBtn1">
                            Hapus
                        </button>
                        </td>
